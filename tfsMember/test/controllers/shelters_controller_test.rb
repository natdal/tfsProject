...
class SheltersControllerTest < ActionController::TestCase
  ...
  test "should create shelter" do
    assert_difference('Shelter.count') do
      post :create, shelter: { introduce: @shelter.introduce, lan: @shelter.lan, lon: @shelter.lon, name: @shelter.name }
    end
  ...
  test "should update shelter" do
    patch :update, id: @shelter, shelter: { introduce: @shelter.introduce, lan: @shelter.lan, lon: @shelter.lon, name: @shelter.name }
    assert_redirected_to shelter_path(assigns(:shelter))
  end
